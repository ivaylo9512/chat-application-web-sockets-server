...
CREATE DATABASE IF NOT EXISTS `chat-app-test` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `chat-app-test`;

-- Dumping structure for table chat-app-test.email_tokens
...
-- Dumping data for table chat-app-test.email_tokens: ~0 rows (approximately)
